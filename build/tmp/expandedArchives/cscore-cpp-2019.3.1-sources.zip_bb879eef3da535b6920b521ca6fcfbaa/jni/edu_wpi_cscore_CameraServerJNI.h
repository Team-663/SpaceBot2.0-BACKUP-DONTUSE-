 ...
 * Signature: (ILjava/lang/String;)Z
 */
JNIEXPORT jboolean JNICALL Java_edu_wpi_cscore_CameraServerJNI_setSinkConfigJson
  (JNIEnv *, jclass, jint, jstring);
 ...
 * Signature: (I)Ljava/lang/String;
 */
JNIEXPORT jstring JNICALL Java_edu_wpi_cscore_CameraServerJNI_getSinkConfigJson
  (JNIEnv *, jclass, jint);
