...
#define ARM_MIN_INTAKE_TICS_FOR_ARM -4600.0

#define ARM_POSITION_DOWN   0
#define ARM_POSITION_LOAD  (1500 *  ARM_TICS_PER_DEGREE)
...
#define ARM_POSITION_MID_HATCH  (3250 * ARM_TICS_PER_DEGREE)
#define ARM_POSITION_HIGH_HATCH (5300 * ARM_TICS_PER_DEGREE)


/*** DO NOT USE FOR PINE TREE
